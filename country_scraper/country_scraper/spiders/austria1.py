...
class AustriaSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10011385']
    ...
    def parse(self, response):
        ...
        item['url'] = 'https://www.ris.bka.gv.at/GeltendeFassung.wxe?Abfrage=Bundesnormen&Gesetzesnummer=10011385'
        item['doc_name'] = 'technical requirements'
        yield item
