...
class LatviaSpider(scrapy.Spider):
    ...
    start_urls = ['https://likumi.lv/ta/id/274865-celu-satiksmes-noteikumi']
    custom_settings = {
    ...
    def parse(self, response): 
        ...
        for ind, i in enumerate(block):
            ...
            if text_new:
                ...
                item['date'] = date_obj
                item['text'] = text_new
                item['url'] = 'https://likumi.lv/ta/id/274865-celu-satiksmes-noteikumi'
                item['file_name'] = 'rules_of_the_road'
                item['country'] = 'Latvia'
                yield item